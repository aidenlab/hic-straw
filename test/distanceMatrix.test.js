...
suite('Distance Matrix', function () {

    suite('computeTraceDistances', function () {

        test('3-vertex trace with known distances', function () {
        ...
        test('3D distance calculation', function () {
        ...
        test('missing data produces DISTANCE_UNDEFINED', function () {
            const vertices = [
                {x: 0, y: 0, z: 0},
        ...
        test('single vertex trace', function () {
    ...
    suite('computeEnsembleDistances', function () {

        test('average of two traces', function () {
            // Trace 0: d(0,1) = 3
            // Trace 1: d(0,1) = 5
            // Average: 4
            const traces = [
        ...
        test('missing data in one trace - averages only valid traces', function () {
        ...
        test('all traces missing for a pair gives DISTANCE_UNDEFINED', function () {
            const traces = [
        ...
        test('diagonal is always 0', function () {
            const traces = [
                [{x: 0, y: 0, z: 0}, {x: 3, y: 0, z: 0}],
        ...
        test('single trace ensemble equals single trace distances', function () {
            const vertices = [
                {x: 0, y: 0, z: 0},
                {x: 3, y: 0, z: 0},
                {x: 0, y: 4, z: 0}
